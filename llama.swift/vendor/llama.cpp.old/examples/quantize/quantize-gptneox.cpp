...
// usage:
//  ./quantize-gptneox models/gptneox/ggml-model.bin models/gptneox/ggml-model-quant.bin type
//
int main(int argc, char ** argv) {
    ...
    const enum gptneox_ftype ftype = (enum gptneox_ftype)atoi(argv[3]);
